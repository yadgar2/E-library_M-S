<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="wievbook.aspx.cs" Inherits="WebApplication1.wievbook" %>
                                                      ...
                                                      Language -<span>&nbsp;</span>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-12">
                                                                            ...
                                                                            &nbsp;| Publish Date -
                                                                            <asp:Label ID="Label7" runat="server" Font-Bold="True" Text='<%# Eval("publishe_date") %>'></asp:Label>
                                                                            &nbsp;| Pages -
